...
<div className='text-center my-10 text-black font-bold'>
  <h1 className="scroll-m-20 text-4xl font-extrabold tracking-tight lg:text-5xl text-wrap">Motorbike Report</h1>
  <h4 className="scroll-m-20 text-xl font-semibold tracking-tight my-5 text-wrap">
  The Fire Wheel motorbike inspection report service will provide a comprehensive overview of your bikes performance and condition. If you’re not enticed by the dependability and security of a vintage motorcycle, our
   inspection report is essential. Whether you are in the market for a bike or not, this report will reveal any hidden issues.
  </h4>
</div>
...
<div className='text-center my-20 text-black font-bold'>
  ...
  <div className="container px-5 py-0 mx-auto">
    ...
    <div className="flex flex-wrap -m-4 justify-around gap-y-4">
      ...
      <div className="p-4 xl:w-1/4 md:w-1/2 w-full px-2 bg-indigo-800 rounded-xl">
        <div className="h-full p-6 rounded-lg border-2 border-blue-600 flex flex-col relative overflow-hidden hover:shadow-lg">
          ...
          <button className=" mt-5 flex items-center text-white bg-indigo-600 border-0 py-2 px-4 w-full focus:outline-none hover:bg-black rounded">
            Buy Now
            <svg
      ...
      <div className="p-4 xl:w-1/4 md:w-1/2 w-full px-2 bg-blue-300 rounded-xl">
        <div className="h-full p-6 rounded-lg border-2 border-blue-600 flex flex-col relative overflow-hidden">
          ...
          <h1 className="text-5xl text-gray-900 pb-4 mb-8 mt-8 border-b border-blue-300 leading-none text-center">
          CA$
          93.20
          </h1>
          <p className="flex items-center text-gray-600 mb-2">
