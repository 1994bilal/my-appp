...
<div className='text-center my-10 text-black font-bold'>
  <h1 className="scroll-m-20 text-4xl font-extrabold tracking-tight lg:text-5xl">ATV Report</h1>
  <h4 className="scroll-m-20 text-xl font-semibold tracking-tight my-5">
  With innovation, challenges, and the sheer thrill of overcoming the environment, this ATV history report is sure to take 
  you on an exciting adventure. So fasten your seatbelts for an exhilarating journey into the core of all-terrain cars!
  </h4>
</div>
